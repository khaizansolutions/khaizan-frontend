        ...
        {productTypes.map((type) => (
          <Link key={type.name} href={type.href} className="group">
            <div className="bg-white border border-gray-100 rounded-xl p-3 sm:p-4 hover:shadow-md hover:border-gray-200 transition-all duration-200 text-center">
              <div className="bg-gray-100 w-10 h-10 sm:w-12 sm:h-12 rounded-xl mx-auto mb-2.5 flex items-center justify-center group-hover:scale-105 group-hover:bg-primary transition-all duration-200">
                <type.icon size={20} className="text-secondary group-hover:text-white transition-colors duration-200" />
              </div>
              ...
              <div className="flex items-center justify-center gap-0.5 text-[9px] sm:text-[10px] font-semibold text-primary">
